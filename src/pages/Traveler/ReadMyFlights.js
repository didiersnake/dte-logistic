...
import { deleteData, readAllData, updateData } from "../../functions/crud";
...
export const ReadMyFlights = ({ user }) => {
  ...
  return (
    <div className="mx-auto max-w-5xl min-h-screen">
          ...
          <li key={person.email} className="flex justify-between gap-x-6 py-5">
            <div className="flex min-w-0 gap-x-8">
              <div className="flex items-center justify-between gap-3">
                ...
                <button onClick={() => deleteData("flight", person.id)}>
      ...
      <Modal1 isOpen={isOpen} closeModal={closeModal} editData={editData} />
    </div>
  );
};

const Modal1 = ({ closeModal, isOpen, editData }) => {
